...
*                       Load param 1
486:    LDA  3,-3(1)	Load address of base of array JuliaVals
487:     ST  3,-7(1)	Save left side 
488:    LDC  3,0(6)	Load integer constant 
489:     LD  4,-7(1)	Load left into ac1 
490:    SUB  3,4,3	compute location from index 
491:     LD  3,0(3)	Load array element 
492:     ST  3,-7(1)	Store parameter 
*                       Load param 2
493:    LDA  3,-3(1)	Load address of base of array JuliaVals
494:     ST  3,-8(1)	Save left side 
495:    LDC  3,1(6)	Load integer constant 
496:     LD  4,-8(1)	Load left into ac1 
497:    SUB  3,4,3	compute location from index 
498:     LD  3,0(3)	Load array element 
499:     ST  3,-8(1)	Store parameter 
*                       Jump to Julia
500:    LDA  1,-5(1)	Load address of new frame 
501:    LDA  3,1(7)	Return address in ac 
502:    LDA  7,-273(7)	CALL Julia
503:    LDA  3,0(2)	Save the result in ac 
*                       End call to Julia
* END COMPOUND
* Add standard closing in case there is no return statement
504:    LDC  2,0(6)	Set return value to 0 
505:     LD  3,-1(1)	Load return address 
506:     LD  1,0(1)	Adjust fp 
507:    LDA  7,0(3)	Return 
* END FUNCTION main
  0:    LDA  7,507(7)	Jump to init [backpatch] 
* INIT
508:     LD  0,0(0)	Set the global pointer 
509:    LDA  1,-9(0)	set first frame at end of globals 
510:     ST  1,0(1)	store old fp (point to self) 
* INIT GLOBALS AND STATICS
* END INIT GLOBALS AND STATICS
511:    LDA  3,1(7)	Return address in ac 
512:    LDA  7,-115(7)	Jump to main 
513:   HALT  0,0,0	DONE! 
* END INIT
