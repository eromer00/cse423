...
* Compound Body
* RETURN
 45:     LD  3,-2(1)	Load address of base of array garion
...
* COMPOUND
 60:    LDC  3,3(6)	load size of array y
 61:     ST  3,-2(1)	save size of array y
* Compound Body
* EXPRESSION
 62:    LDC  3,1(6)	Load integer constant 
 63:     ST  3,-6(1)	Save index 
 64:    LDC  3,666(6)	Load integer constant 
 65:     LD  4,-6(1)	Restore index 
 66:    LDA  5,-3(1)	Load address of base of array y
...
*                       Load param 1
*                       Begin call to  wolf
 70:     ST  1,-8(1)	Store old fp in ghost frame 
*                       Load param 1
 71:    LDA  3,-3(1)	Load address of base of array y
 72:     ST  3,-10(1)	Store parameter 
*                       Jump to wolf
 73:    LDA  1,-8(1)	Load address of new frame 
 74:    LDA  3,1(7)	Return address in ac 
 75:    LDA  7,-34(7)	CALL wolf
...
* EXPRESSION
*                       Begin call to  outnl
 82:     ST  1,-6(1)	Store old fp in ghost frame 
*                       Jump to outnl
